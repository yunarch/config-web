...
Please check the table below for the supported versions of `@yunarch/config-web` that currently receive security updates.
...
We take the security of our project seriously. If you discover a security vulnerability in `@yunarch/config-web`, please **DO NOT** open a public issue.
