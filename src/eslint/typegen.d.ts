...
export type ConfigNames = 'yunarch/base/ignores' | 'yunarch/base/setup' | 'yunarch/base/rules' | 'yunarch/typescript/setup' | 'yunarch/typescript/parser' | 'yunarch/typescript/parser/type-aware' | 'yunarch/typescript/rules' | 'yunarch/typescript/rules/type-aware' | 'yunarch/import/rules' | 'yunarch/import/typescript/rules' | 'yunarch/jsdoc/rules' | 'yunarch/jsdoc/typescript/rules' | 'yunarch/unicorn/rules' | 'yunarch/test/setup' | 'yunarch/test/rules' | 'yunarch/tanstack/query/rules' | 'yunarch/tanstack/router/rules' | 'yunarch/perfectionist/rules' | 'yunarch/disables/cli' | 'yunarch/disables/dts' | 'yunarch/disables/prettier';